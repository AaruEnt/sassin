...
namespace Autohand {
    ...
    public class HandAnimator : MonoBehaviour {
        ...
        float targetPoseTotalTransitionTime = 0.01f;
        ...
        protected virtual void UpdateTargetPoseState() {
            ...
            {
                UnityEngine.Debug.LogWarning("divide by 0 error");
                currentPoseState = targetTransitionAnimationCurve.Evaluate(1);
            }
        ...
        public void CancelPose(float cancelPoseTransitionTime) {
            if (cancelPoseTransitionTime == 0)
                cancelPoseTransitionTime = 0.1f;
