	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 tanNormal12_g7 = NormalmapXYZ572;
				...
				#endif
				float4 lerpResult595 = lerp( ( ( _Color * tex2D( _MainTex, uv_MainTex ) ) * float4( ( ( ( max( dotResult577 , 0.0 ) * ( ase_lightAtten * _MainLightColor.rgb ) ) + lambertResult38_g7 ) + bakedGI585 ) , 0.0 ) ) , float4( indirectSpecular594 , 0.0 ) , staticSwitch592);
