	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#endif
				float4 lerpResult559 = lerp( ( ( _Color * tex2D( _MainTex, uv_MainTex ) ) * float4( ( ( ( max( dotResult540 , 0.0 ) * ( ase_lightAtten * _MainLightColor.rgb ) ) + lambertResult38_g1 ) + bakedGI550 ) , 0.0 ) ) , float4( indirectSpecular557 , 0.0 ) , staticSwitch556);
